...
namespace MOAED_2_sem
{
    public partial class MOAED_2_sem : Form
    {
        ...
        {
            if (filtrationPictureCB.SelectedIndex == -1 || filtrationModelCB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose models.");
                return;
            }
        ...
        private void lpFilter_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.lowPassFilterImage(modelsLB.SelectedItem.ToString(), analNewNameTB.Text, Convert.ToDouble(1 / hfNUD.Value), Convert.ToDouble(mFilterNUD.Value));
        ...
        private void hpFilter_Click(object sender, EventArgs e)
        {
            ...
            calc_core.hightPassFilterImage(modelsLB.SelectedItem.ToString(), analNewNameTB.Text, Convert.ToDouble(1 / lfNud.Value), Convert.ToDouble(mFilterNUD.Value));

            change_list();
        }

        private void stonesCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (morphoTypeCB.SelectedIndex)
            {
                case 0:
                    excretionGB.BringToFront();
                    break;
                case 1:
                    morphoUniteCB.BringToFront();
                    break;
                case 2:
                    morphoFindGB.BringToFront();
                    break;
                case 3:
                    morphoCountGB.BringToFront();
                    break;
                default:
                    break;
            }
        ...
        private void excretionMatrixCB_Click(object sender, EventArgs e)
        {
            excretionMatrixCB.Items.Clear();
            string[] tmp = new string[modelsLB.Items.Count];
            modelsLB.Items.CopyTo(tmp, 0);

            excretionMatrixCB.Items.AddRange(tmp);
        }

        private void eroseStonesBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            if (excretionMatrixCB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose matrix.");
                return;
            }

            calc_core.eroseImage(modelsLB.SelectedItem.ToString(), excretionMatrixCB.SelectedItem.ToString(), newNameMorphoTB.Text);
        ...
        {
            if (uniteFurstCB.SelectedIndex == -1 || uniteSecondCB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
                return;
            }

            calc_core.interceptMorphoImage(uniteFurstCB.SelectedItem.ToString(), uniteSecondCB.SelectedItem.ToString(), newNameMorphoTB.Text);
        ...
        private void differenceBtn_Click(object sender, EventArgs e)
        {
            ...
            calc_core.differenceMorphoImage(uniteFurstCB.SelectedItem.ToString(), uniteSecondCB.SelectedItem.ToString(), newNameMorphoTB.Text);
        ...
        private void unionBtn_Click(object sender, EventArgs e)
        {
            ...
            calc_core.uniteMorphoImage(uniteFurstCB.SelectedItem.ToString(), uniteSecondCB.SelectedItem.ToString(), newNameMorphoTB.Text);

            change_list();
        }

        private void uniteFurstCB_Click(object sender, EventArgs e)
        {
            uniteFurstCB.Items.Clear();
            string[] tmp = new string[modelsLB.Items.Count];
            modelsLB.Items.CopyTo(tmp, 0);

            uniteFurstCB.Items.AddRange(tmp);
        }

        private void uniteSecondCB_Click(object sender, EventArgs e)
        {
            uniteSecondCB.Items.Clear();
            string[] tmp = new string[modelsLB.Items.Count];
            modelsLB.Items.CopyTo(tmp, 0);

            uniteSecondCB.Items.AddRange(tmp);
        }

        private void morphoAdditionBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.addMorphoImage(modelsLB.SelectedItem.ToString(), excretionMatrixCB.SelectedItem.ToString(), newNameMorphoTB.Text);

            change_list();
        }

        private void fillMorphoBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.fillMorphoImage(modelsLB.SelectedItem.ToString(), excretionMatrixCB.SelectedItem.ToString(), newNameMorphoTB.Text);

            change_list();
        }

        private void haffTransBnt_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            if (haffMatrixCB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose matrix.");
                return;
            }

            calc_core.modelFindImage(modelsLB.SelectedItem.ToString(), haffMatrixCB.SelectedItem.ToString(), newNameMorphoTB.Text, Convert.ToDouble(morphoFindStageNUD.Value));

            change_list();

        }

        private void haffMatrixCB_Click(object sender, EventArgs e)
        {
            haffMatrixCB.Items.Clear();
            string[] tmp = new string[modelsLB.Items.Count];
            modelsLB.Items.CopyTo(tmp, 0);

            haffMatrixCB.Items.AddRange(tmp);

        }

        private void hafRoundBtn_Click(object sender, EventArgs e)
        {
            ...
            calc_core.hafFindImage(modelsLB.SelectedItem.ToString(), newNameMorphoTB.Text, Convert.ToDouble(hafRoundNUD.Value), Convert.ToDouble(morphoFindStageNUD.Value));

            change_list();
        }

        private void MoprphoFindBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.modelFindCentresImage(modelsLB.SelectedItem.ToString(), haffMatrixCB.SelectedItem.ToString(), newNameMorphoTB.Text);

            change_list();
        }

        private void morphoCountBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.countBodiesImage(modelsLB.SelectedItem.ToString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            calc_core.countBodiesOfSize(modelsLB.SelectedItem.ToString(), Convert.ToInt32(morphoCountVertNUD.Value), Convert.ToInt32(morphoCountHorNUD.Value), morphoAnySizeChB.Checked);

        }

        private void GreyTheresholdBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.greyThresholdTransform(modelsLB.SelectedItem.ToString(), simpleNewNameTB.Text, Convert.ToInt32(greyEmbarkNUD.Value));

            change_list();
        }

        private void bordersLapBtn_Click(object sender, EventArgs e)
        {
            if (modelsLB.SelectedIndex == -1)
            {
                MessageBox.Show("Please, choose model.");
            ...
            calc_core.findBordersByLaplacian(modelsLB.SelectedItem.ToString(), analNewNameTB.Text);
